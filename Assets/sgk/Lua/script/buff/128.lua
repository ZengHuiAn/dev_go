function targetBeforeHit(target, buff, bullet)
	if buff.cfg_property[3] and target.hp/target.hpp <= (buff.cfg_property[3] or 4000)/10000 then
...
function attackerBeforeHit(target, buff, bullet)
	if Hurt_Effect_judge(bullet) and target.hp/target.hpp <= (buff.cfg_property[3] or 4000)/10000 then

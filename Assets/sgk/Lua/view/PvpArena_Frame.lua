...
function View:InitView()
    ...
    -- CS.UGUIPointerEventListener.Get(self.view.top.reward_btn.gameObject).onPointerDown = function(start, pos)
    --     self.view.top.reward:SetActive(true);
    -- end
    -- CS.UGUIPointerEventListener.Get(self.view.top.reward_btn.gameObject).onPointerUp = function(start, pos)

...
function homeScenes:initUi()
    -- CS.ModelClickEventListener.Get(self.view.manor.gameObject).onClick = function(start, pos)
    ...
    --     end
    -- end
    -- CS.ModelClickEventListener.Get(self.view.manor.title.gameObject).onClick = function(start, pos)
    --     if not utils.SGKTools.GetTeamState() or utils.SGKTools.isTeamLeader() then
    --         SceneStack.EnterMap(26, {mapid = 26, mapType = 1})
    --     else
    --         showDlgError(nil, "在队伍中,无法操作")
